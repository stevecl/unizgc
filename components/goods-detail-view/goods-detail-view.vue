        ...
        <view scroll-y="true" class="goods-detail" :class="isIphoneX ? 'active' : ''">
            <view class="goods-container">
                ...
                <pengpai-fadein-out v-if="goodsSkuDetail.barrage_show && goodsSkuDetail.barrageData" ref="pengpai"
                    ...
                    :info="goodsSkuDetail.barrageData"></pengpai-fadein-out>
                ...
                <view class="newdetail margin-bottom">
                    ...
                    <!-- 门店 -->
                    <view class="item store-wrap" @click="openStoreListPopup()"
                        v-if="addonIsExist.store && globalStoreInfo && isShowStore">
                        ...
                        <view class="list-wrap">
                            ...
                            <view class="other-wrap">
                                <text class="distance"
                                    v-if="parseFloat(globalStoreInfo.distance)">距离{{ globalStoreInfo.distance > 1 ? globalStoreInfo.distance + 'km' : globalStoreInfo.distance * 1000 + 'm' }}</text>
