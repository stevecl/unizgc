		...
		<view class="pintuan-wrap">
			...
			<view class="pintuan-clustering">
				...
				<view class="pintuan-btn-box" v-if="groupDetail.status != 1">
					<button class="one_btn pintuan-btn" v-if="groupDetail.pintuan_status == 3"
						@click="orderDetail(groupDetail)">查看订单</button>
				...
				<view class="pintuan-btn-box"
					v-else-if="groupDetail.pintuan_status == 1 || groupDetail.pintuan_status == 3">
					<button type="primary" class="pintuan-btn"
						@click="$util.redirectTo('/pages_promotion/pintuan/list')">再次发起拼团</button>
					<button class="one_btn pintuan-btn" v-if="groupDetail.pintuan_status == 3"
						@click="orderDetail(groupDetail)">查看订单</button>
				</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			copyUrl() {
				let text = this.$config.h5Domain + '/pages_promotion/pintuan/detail?pintuan_id=' + this.groupDetail
			 ...
			 */
			setPublicShare() {
				let shareUrl = this.$config.h5Domain + '/pages_promotion/pintuan/detail?pintuan_id=' + this.groupDetail
					.pintuan_id + '&group_id=' + this.groupDetail.group_id;
		...
		onShareAppMessage(res) {
			var path = '/pages_promotion/pintuan/detail?pintuan_id=' + this.groupDetail.pintuan_id + '&group_id=' + this
