        ...
        <mescroll-uni @getData="getData" ref="mescroll" :size="10">
            <block slot="list">
                <view class="cf-container color-line-border">
                    <view class="tab">
                        <view @click="changeState('all')"><text :class="status == 'all' ? ' active ' : ''">全部</text>
                        </view>
                        <view @click="changeState('to_use')"><text
                                :class="status == 'to_use' ? ' active ' : ''">待使用</text></view>
                        <view @click="changeState('used')"><text :class="status == 'used' ? ' active ' : ''">已使用</text>
                        </view>
                        <view @click="changeState('expire')"><text
                                :class="status == 'expire' ? ' active ' : ''">已过期</text></view>
                    </view>
                </view>
                ...
                <view class="card-no-data" v-else>
                    ...
                    <view class="btn"><button type="primary" size='mini'
                            @click="$util.redirectTo('/pages_promotion/giftcard/index')">去逛逛</button></view>
                </view>
            </block>
        </mescroll-uni>
        ...
        <view class="tab-bar">
            ...
            <view class="item" v-for="(item, index) in tabList" :key="index" @click="tabRedirectTo(item.link)">
                <view class="bd">
                    ...
                    <view class="label"
                        :style="{color: item.selected ? themeStyle.giftcard.giftcard_promotion_color : ''}">
                        {{ item.text }}
                    </view>
                </view>
            </view>
