		...
		<view>
			...
			<uni-popup ref="transitionPopup" type="center" :maskClick="false">
				<view class="transition-popup">
					<view class="wrap">
						<image :src="$util.img('public/uniapp/game/golden_eggs_0.png')" mode="widthFix" class="eggs"
							v-if="eggStatus == 0"></image>
						<image :src="$util.img('public/uniapp/game/golden_eggs_1.png')" mode="widthFix" class="eggs"
							v-if="eggStatus == 1"></image>
						<image :src="$util.img('public/uniapp/game/golden_eggs_2.png')" mode="widthFix" class="eggs"
							v-if="eggStatus == 2"></image>
				...
				<view class="result-wrap">
					<block v-if="result.is_winning">
						<view class="content-wrap yes">
							<image :src="$util.img('public/uniapp/game/point.png')" mode="widthFix"
								v-if="result.award_type == 1" class="look"></image>
							<image :src="$util.img('public/uniapp/game/balance.png')" mode="widthFix"
								v-if="result.award_type == 2" class="look"></image>
							<image :src="$util.img('public/uniapp/game/coupon.png')" mode="widthFix"
								v-if="result.award_type == 3" class="look"></image>
							<image :src="$util.img('public/uniapp/game/gift.png')" mode="widthFix"
								v-if="result.award_type == 4" class="look"></image>
					...
					<view class="content-wrap">
						...
						<scroll-view scroll-y="true" class="rule">
							<view>
								...
								<view class="text" v-if="gameInfo.join_type == 0">
									每个用户活动期间共有{{ gameInfo.join_frequency }}次抽奖机会。</view>
