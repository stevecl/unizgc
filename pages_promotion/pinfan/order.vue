            ...
            <view class="layer">
                <view class="popup-center">
                    ...
                    <view class="popup-center-center">
                        <view class="popup-center-center-image" v-for="(item, index) in groupDetail.member_list"
                            :key="index">
                            <image
                                :src="item.member_img ? $util.img(item.member_img) : $util.img('public/uniapp/common/default_headimg.png')"
                                mode=""></image>
        ...
        methods: {
                    ...
                    success: res => {
                        if (res.code == 0) {
                            ...
                            if (res.data.end_time > res.timestamp) {
                                res.data.timeMachine = this.$util.countDown(res.data.end_time - res
                                    .timestamp);
                            } else {
            ...
            delegation() {
                if (!uni.getStorageSync('token')) {
                    setTimeout(() => {
                        this.$refs.login.open('/pages_promotion/pinfan/order?pinfan_id=' + this.pinfan_id +
                            '&group_id=' + this.groupId + '&id=' + this.id);
                    });
                    return;
                }
            ...
            async getGoodsSkuDetail() {
                ...
                if (data.goods_sku_detail != null) {
                    ...
                    if (this.goodsSkuDetail.end_time - res.timestamp > 0) {
                        ...
                        setTimeout(() => {
                            this.$util.redirectTo('/pages/goods/detail', { goods_id: this.goodsSkuDetail
                                    .goods_id }, 'redirectTo');
                        }, 1000);
                    }
                    ...
                    if (this.goodsSkuDetail.sku_images) this.goodsSkuDetail.sku_images = this.goodsSkuDetail
                        .sku_images.split(',');
                    ...
                    if (this.goodsSkuDetail.goods_spec_format && this.goodsSkuDetail.goods_image) {
                        ...
                        this.goodsSkuDetail.sku_images = this.goodsSkuDetail.sku_images.concat(this.goodsSkuDetail
                            .goods_image);
                    }
                    ...
                    this.goodsSkuDetail.save_price =
                        this.goodsSkuDetail.price - this.goodsSkuDetail.show_price > 0 ? (this.goodsSkuDetail
                    ...
                    if (this.goodsSkuDetail.goods_attr_format) {
                        ...
                        for (var i = 0; i < this.goodsSkuDetail.goods_attr_format.length; i++) {
                            for (var j = 0; j < goods_attr_format.length; j++) {
                                if (
                                    this.goodsSkuDetail.goods_attr_format[i].attr_id == goods_attr_format[j]
                                    .attr_id &&
                                    this.goodsSkuDetail.goods_attr_format[i].attr_value_id != goods_attr_format[j]
                                    .attr_value_id
                                ) {
            ...
            resetPrice() {
                ...
                this.goodsSkuDetail.save_price =
                    this.goodsSkuDetail.price - this.goodsSkuDetail.show_price > 0 ? (this.goodsSkuDetail.price - this
                        .goodsSkuDetail.show_price).toFixed(2) : 0;
                this.$forceUpdate();
            },
