			...
			<swiper-item v-for="(item, index) in poster" :key="index">
				<view class="swiper-item">
					<view class="poster-wrap">
						<image :src="$util.img(item)" mode="widthFix" :show-menu-by-longpress="true"></image>
					</view>
				</view>
			</swiper-item>
		</swiper>
		...
		<uni-popup ref="popupDialog" :custom="true" :mask-click="false">
			<view class="dialog-popup">
				...
				<view class="action-wrap">
					...
					<view><button type="default" open-type="openSetting" @opensetting="closeDialog"
							hover-class="none">立即授权</button></view>
				</view>
			</view>
		</uni-popup>
