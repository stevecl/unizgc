        ...
        async getGoodsSkuDetail() {
            ...
            if (data.goods_sku_detail != null) {
                ...
                if (this.goodsSkuDetail.seckill_start_time <= currentTime && currentTime < this.goodsSkuDetail
                    ...
                    (res.timestamp > this.goodsSkuDetail.end_time) ||
                    (this.goodsSkuDetail.seckill_start_time == 0 && this.goodsSkuDetail.seckill_end_time == 0) ||
                    (currentTime < this.goodsSkuDetail.seckill_start_time && currentTime > this.goodsSkuDetail
                        .seckill_end_time)) {
                    this.$util.showToast({
                        title: "限时秒杀活动已结束",
                    });
