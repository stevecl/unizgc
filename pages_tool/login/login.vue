	...
	<scroll-view scroll-y="true" class="container">
		...
		<view class="body-wrap">
			<view class="form-wrap">
				<view class="input-wrap" v-show="loginMode == 'mobile'">
					<view class="content">
						...
						<input type="number" placeholder="仅限中国大陆手机号登录" placeholder-class="input-placeholder"
				...
				<view class="input-wrap" v-show="loginMode == 'account'">
					<view class="content">
						<input type="password" placeholder="请输入密码" placeholder-class="input-placeholder" class="input"
							v-model="formData.password" />
						<view class="align-right" v-show="loginMode == 'account'"><text
								@click="forgetPassword">忘记密码?</text></view>
					</view>
				</view>
			...
			<view class="btn_view">
				...
				<!-- #ifdef MP -->
				<button open-type="getPhoneNumber" class="auth-login color-base-border"
