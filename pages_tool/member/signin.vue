					...
					<view class="member-info">
						<view class="headimg">
							<view class="headimg-img">
								<image :src="headimg ? $util.img(headimg) : $util.getDefaultImage().head"
									mode="aspectFill" @error="headimg = $util.getDefaultImage().head"></image>
							</view>
						...
						<view class="point-box" @click="sign()">
							<image
								:src="$util.img(hasSign == 1 ? 'public/uniapp/signin/sign-btn-res.png' : 'public/uniapp/signin/sign-btn.png')"
								mode="widthFix"></image>
						</view>
					</view>
								...
								<view class="signin-day-scroll">
									<block v-for="(item, index) in showSignDays">
										...
										<view v-else :id="'id_' + item.day" class="signin-day-item last" :class="{
											...
											<image :src="$util.img('public/uniapp/signin/sign-box.png')"
												mode="widthFix"></image>
										</view>
									</block>
								</view>
