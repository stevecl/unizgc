...
export default {
    ...
    methods: {
        // 处理商品详情数据
        handleGoodsSkuData() {
            this.$langConfig.title(this.goodsSkuDetail.goods_name.length > 9 ? this.goodsSkuDetail.goods_name.substr(0,
                9) + "..." : this.goodsSkuDetail.goods_name);
            this.navbarData.title = this.goodsSkuDetail.goods_name.length > 9 ? this.goodsSkuDetail.goods_name.substr(0,
                9) + "..." : this.goodsSkuDetail.goods_name;
